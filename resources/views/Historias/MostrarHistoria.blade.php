...
<div class="row">
    <div class="form-group col-2 col-sm-2 col-md-2 col-lg-2 ">
            <a class="btn btn-primary" href="{{ route('AgregarControl.index',['historia'=>$historia->num_h,'historiano'=>'NULL'])}}">Agregar Control</a>
    </div>
    <div class="form-group col-2 col-sm-2 col-md-2  col-lg-2">
            <a class="btn btn-primary" href="{{ route('ListaControles.index',['historia'=>$historia->num_h,'historiano'=>'NULL'])}}">Ver Controles</a>
    </div>
        @if($paciente->historia_id!=NULL)
            <div class="form-group col-2 col-sm-2 col-md-3 col-lg-3">
            @if($retino==NULL)
                    <a class="btn btn-primary" href="{{ route('AgregarRetino.index',['historia'=>$historia->num_h])}}">Llenar Retinoblastoma</a>
            @else
                    <a class="btn btn-primary" href="{{ route('AgregarRetino.show',['historia'=>$historia->num_h])}}">Ver Retinoblastoma</a>
            @endif
            </div>
        @endif
